...
public class Fulcio {
     ...
     */
    public CertPath getSigningCert(final String signedEmail, final PublicKey pubKey, final String idToken) throws IOException, CertificateException {
        ...
        final HttpRequest req = httpTransport.createRequestFactory().buildPostRequest(fulcioPostUrl, jsonContent);
